  ...
  const menuItems = [
    {
      ...
      price: "$15.00",
      image: "/placeholder.svg?height=64&width=64&text=Dish+1",
    },
    {
      name: "Butternut Squash Soup",
      description: "Ricotta, goat cheese, beetroot and dateline.",
      price: "$15.00",
      image: "/placeholder.svg?height=64&width=64&text=Dish+2",
    },
    {
      name: "Braised Short Ribs",
      description: "Ricotta, goat cheese, beetroot and dateline.",
      price: "$15.00",
      image: "/placeholder.svg?height=64&width=64&text=Dish+3",
    },
    {
      name: "Braised Short Ribs",
      description: "Ricotta, goat cheese, beetroot and dateline.",
      price: "$15.00",
      image: "/placeholder.svg?height=64&width=64&text=Dish+4",
    },
    {
      name: "Mushroom Arancini",
      description: "Ricotta, goat cheese, beetroot and dateline.",
      price: "$15.00",
      image: "/placeholder.svg?height=64&width=64&text=Dish+5",
    },
  ];
            ...
            <div className="space-y-6">
              {menuItems.map((item, index) => (
                <div key={index} className="flex items-center gap-4">
                  <div className="flex-shrink-0 w-16 h-16 rounded-full overflow-hidden bg-[#D9D9D9]"></div>
                  <div className="flex-1">
                    <div className="flex justify-between items-baseline">
                      <h4 className="text-lg font-semibold">{item.name}</h4>
                      <span className="text-[#CB3A1A] text-lg font-semibold">
                        {item.price}
                      </span>
                    </div>
      ...
      <div className="bg-white py-16 md:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#111111] leading-tight mb-4">
              OUR POPULAR CHEFS
            </h2>
            <div className="flex justify-center gap-2">
              <span className="w-2 h-2 bg-[#CB3A1A] rounded-full"></span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {chefs.map((chef, index) => (
              <div
                key={index}
                className="flex flex-col shadow-lg rounded-sm overflow-hidden"
              >
                <div className="w-full aspect-[4/3] bg-[#D9D9D9] overflow-hidden"></div>
                <div className="bg-[#111111] text-white py-4 px-4 flex items-center justify-between">
                  ...
                  <button className="bg-[#CB3A1A] p-2 rounded-sm -mt-10 flex-shrink-0">
