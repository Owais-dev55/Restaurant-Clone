    ...
    <footer className="bg-black text-gray-300 pt-12 pb-6 px-6 md:px-16">
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-5 gap-10">
        ...
        <div className="space-y-4">
          <img src={logo} alt="Delish Logo" className="h-10 object-contain" />
          <p>
            1234, Restaurant St,
            <br />
            South City, New York 0124
          </p>
          <div className="flex space-x-3">
            <div className="bg-orange-600 text-white p-2 rounded-full cursor-pointer">
              <FaFacebookF />
            </div>
